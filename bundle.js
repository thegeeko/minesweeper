...
eval("// check browser support\nvar supported = (function () {\n    try {\n        if (typeof WebAssembly === \"object\" &&\n            typeof WebAssembly.instantiate === \"function\") {\n            var module_1 = new WebAssembly.Module(Uint8Array.of(0x0, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00));\n            if (module_1 instanceof WebAssembly.Module)\n                return new WebAssembly.Instance(module_1) instanceof WebAssembly.Instance;\n        }\n    }\n    catch (e) { }\n    return false;\n})();\n// lazy load the main file\nif (supported) {\n    __webpack_require__.e(/*! import() */ \"src_index_ts\").then(__webpack_require__.bind(__webpack_require__, /*! ./index */ \"./src/index.ts\")).catch(function (e) {\n        return console.error(\"Error importing **index.ts**:\", e);\n    });\n}\n\n\n//# sourceURL=webpack://minesweeper/./src/bootstrap.ts?");
